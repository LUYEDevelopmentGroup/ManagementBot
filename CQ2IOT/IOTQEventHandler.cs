...
namespace CQ2IOT
{
    public class IOTQEventHandler
    {
        ...
        public event PrivateMessageReceiveEvent onPrivateMessageReceive;
        public event GroupMessageRevokeEvent onGroupMessageRevoke;
        ...
        public delegate void PrivateMessageReceiveEvent(object sender, PrivateMessageReceiveEventArgs args);
        ...
        public delegate void GroupMessageRevokeEvent(object sender, GroupMessageRevokeEventArgs args);

        public IOTQEventHandler(EventHost host)
        {
            this.host = host;
            while (!host.ready) { Thread.Sleep(500); }
