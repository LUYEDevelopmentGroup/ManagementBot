...
namespace MinecraftClient.Commands
{
    internal class Inventory : Command
    {
        ...
        public override string CMDDesc => "inventory <<id>|player|container> <list|close|drop <slot> <1|all>|click <slot> <left|right|middle>> | inventory creativegive <slot> <itemtype> <count>: Interact with inventories";
                    ...
                    try
                    {
                        ...
                        switch (action)
                        {
                            ...
                            case "list":
                                ...
                                {
                                    "Inventory #" + inventoryId + " - " + inventory.Title + "§8"
                                };
