...
namespace MinecraftClient.Protocol.Handlers
{
    ...
    /// </remarks>
    internal class Protocol18Handler : IMinecraftCom
    {
        ...
        private readonly Protocol18Forge pForge;
        private readonly Protocol18Terrain pTerrain;
                        ...
                        case PacketIncomingType.EntityProperties:
                            if (handler.GetEntityHandlingEnabled())
                            {
                                ...
                                for (int i = 0; i < NumberOfProperties; i++)
                                {
                                    ...
                                    if (op2.Count > 0)
                                    {
                                        _value *= op2.Aggregate((a, _x) => a * _x);
                                    }
