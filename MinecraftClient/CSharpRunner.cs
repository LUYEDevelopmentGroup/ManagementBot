...
namespace MinecraftClient
{
    ...
    public class CSharpException : Exception
    {
        ...
        public CSErrorType ExceptionType => _type;
    ...
    public class CSharpAPI : ChatBot
    {
        ...
        /// </summary>
        private readonly ManualResetEvent tickHandler;
        ...
        public new void LogToConsole(object text)
        {
        ...
        public new bool PerformInternalCommand(string command, Dictionary<string, object> localVars = null)
        {
            if (localVars == null)
            {
        ...
        public new void ReconnectToTheServer(int extraAttempts = -999999, int delaySeconds = 0)
        {
        ...
        /// </summary>
        public new void DisconnectAndExit()
        {
        ...
        public new void LoadBot(ChatBot bot)
        {
            base.LoadBot(bot);
            tickHandler.WaitOne();
        }
        ...
        public new string[] GetOnlinePlayers()
        {
        ...
        public new Dictionary<string, string> GetOnlinePlayersWithUUID()
        {
