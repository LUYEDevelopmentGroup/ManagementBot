...
namespace MinecraftClient.Mapping.EntityPalettes
{
    ...
    {
        private static readonly Dictionary<int, EntityType> mappingsObjects = new Dictionary<int, EntityType>()
        {
        ...
        private static readonly Dictionary<int, EntityType> mappingsMobs = new Dictionary<int, EntityType>()
        {
