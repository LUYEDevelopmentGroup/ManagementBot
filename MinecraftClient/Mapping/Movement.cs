    ...
    public static class Movement
    {
        ...
        public static Queue<Location> CalculatePath(World world, Location start, Location goal, bool allowUnsafe = false)
        {
            ...
            AutoTimeout.Perform(() =>
            {
                ...
                Dictionary<Location, int> g_score = new Dictionary<Location, int>
                {
                    [start] = 0 // Cost from start along best known path.
                }; //:= map with default value of Infinity
                // Estimated total cost from start to goal through y.
                Dictionary<Location, int> f_score = new Dictionary<Location, int>
                {
                    [start] = (int)start.DistanceSquared(goal) //heuristic_cost_estimate(start, goal)
                }; //:= map with default value of Infinity
